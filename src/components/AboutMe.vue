    ...
    <div class="text-lg lg:w-1/2  xl:w-2/6 md:w-3/4">
      <div v-if="isInEnglish" class="about-me-element px-2 ">
          ...
          <p class="text-about">
            ...
            <p class="text-about">
                  I consider myself a person highly  <span class="font-bold">disciplined</span>  , able to adapt and learn any technology. I enjoy learning, creating and collaborating with people on projects, apart from programming, I also like to practice calisthenics, read books and the nature.
            </p>
...
export default {
    data(){
        return {
            dateInSpanish: timeago.format('2021-04-16', 'es_ES'),
            dateInEnglish: timeago.format('2021-04-16', 'en_US')
...
timeago.register('es_ES', localeFunc);
